	...
	<div class="theme-container">
		<div class="theme-grid gap-y-[50px] md:gap-y-0 items-start">
			...
			<div class="col-span-2 md:col-span-6 block xl:hidden">
				<h2 class="title-main italic text-off-white xl:pb-16"><?php the_field( 'celebrate_title' ); ?></h2>
			</div>
			...
			<div class="col-span-2 md:col-span-3 xl:col-span-7 pt-0 xl:pr-10">
				...
				<?php if ( get_field( 'celebrate_image_left' ) ) : ?>
					<?php echo wp_get_attachment_image(
						...
						false,
						array(
							'class' => 'celebrate_image_left w-full xl:h-auto mt-0 md:mt-24 xl:mt-0',
						)
					); ?>
				<?php endif; ?>
			</div>
			...
			<div class="col-span-2 md:col-span-3 xl:col-span-5">
				...
				<?php if ( have_rows( 'celebrate_items' ) ) : ?>
					<ul class="celebrate-items flex flex-col xl:flex-row mt-8 md:mt-[4.65rem] xl:mt-32 2xl:mt-40">
						<?php while ( have_rows( 'celebrate_items' ) ) : the_row(); ?>
							<?php
							$item_icon = get_sub_field( 'icon' );
							$item_text = get_sub_field( 'text' );
							?>
							<li class="celebrate-items__item flex flex-row xl:flex-col items-start mb-10 xl:mb-0 gap-9 xl:gap-4 flex-1">
								<?php if ( $item_icon ) : ?>
									<?php
