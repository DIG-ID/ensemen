...
?>
<section id="section-hero" class="section-hero bg-brown pt-12 pb-20 md:pt-20 md:pb-[100px] xl:pt-24 xl:pb-0">
    ...
    <div class="theme-grid">
      ...
      <div class="col-start-1 col-span-2 md:col-start-4 md:col-span-3 xl:col-start-7 xl:col-span-6">
        <h2 class="over-title text-off-white pt-8 pb-2.5 md:pt-0 md:pb-2.5 xl:pb-8"><?php the_field( 'hero_over-title' ); ?></h2>
        ...
        <div class="flex flex-col gap-y-7 xl:grid xl:grid-cols-6 xl:gap-x-5 xl:gap-y-0">
          <div class="w-full md:col-start-1 md:col-span-4 xl:col-start-1 xl:col-span-2">
            <?php
          ...
          <div class="w-full md:col-start-1 md:col-span-4 xl:col-start-4 xl:col-span-2">
            <?php
