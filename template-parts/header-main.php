...
<header id="header-main" class="header-main bg-brown" itemscope itemtype="http://schema.org/WebSite">
	<div class="theme-container">
		<div class="theme-grid items-center xl:py-7">
			<div class="header-main__logo xl:col-start-2 xl:col-span-3 max-w-[261px]">
				<?php do_action( 'theme_logo_white' ); ?>
			</div>

			<?php if ( ! empty( $menu_items ) ) : ?>
				<nav class="header-main__nav xl:col-start-5 xl:col-span-4" aria-label="<?php esc_attr_e( 'Main menu', 'ensemen' ); ?>">
			...
			<?php if ( $reservation ) : ?>
				<div class="header-main__reservation xl:col-start-10 xl:col-span-2">
					<a
					...
					>
						<?php echo esc_html( $reservation['title'] ); ?>
					</a>
				</div>
			<?php endif; ?>
		</div>
